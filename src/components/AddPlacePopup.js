...
function AddPlacePopup ({isOpen, onClose, onSubmit, submitText}){
    ...
    return(
        <PopupWithForm title={'Новое место'}
            ...
            <fieldset className="form__profile-info">
                <input className="form__input form__input_card_heading"
                ...
                <input className="form__input form__input_card_link"
                       type="url"
                       value={cardLink || ''}
